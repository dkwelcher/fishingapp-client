    ...
    <form className="sm:grid sm:grid-cols-2 gap-x-4">
      <div className={inputContainerStyles}>
        ...
        <input
          ...
          onChange={(e) => setTempCatch({ ...tempCatch, time: e.target.value })}
      ...
      <div className={inputContainerStyles}>
        ...
        <input
          ...
          onChange={(e) => setTempCatch({ ...tempCatch, fish: e.target.value })}
      ...
      <div className={inputContainerStyles}>
        ...
        <input
          ...
          onKeyDown={(e) => preventDigitAndSpecialCharacters(e)}
          onChange={(e) => setTempCatch({ ...tempCatch, bait: e.target.value })}
