...
function Layout() {
  return (
    <>
      <div className="bg-hero-image bg-cover bg-center h-[80vh] p-4 font-montserrat font-medium">
        <nav>
          <header className="flex justify-between">
            <div className="flex pl-8 justify-center items-center">
              ...
              <a className="hover:no-underline" href="#">
                <h2 className="text-5xl pl-2 text-white font-caveat font-black">
                  Fishing App
                </h2>
              </a>
            </div>
        ...
        <div className="flex flex-col justify-center items-center h-4/5">
          <h1 className="w-3/6 text-center font-rubik font-bold text-8xl leading-normal text-white text-shadow">
      ...
      <main>
        <div className="pt-32 pb-0 px-[20%]">
          <div className="flex">
            ...
            />
            <div className="pl-24">
              <h2 className="text-5xl font-montserrat font-semibold">
                What is <span className="text-blue-700">Fishing App?</span>
              </h2>
              <p className="text-zinc-600 pt-4 text-xl font-montserrat font-medium">
        ...
        <div className="pt-32 pb-0 px-[20%]">
          <div className="flex">
            <div className="pr-24">
              ...
              <p className="text-zinc-600 pt-4 text-2xl font-montserrat font-medium">
        ...
        <div className="flex bg-callout-image bg-cover bg-center h-[1000px] mt-32 justify-center items-center">
          <div className="flex flex-col justify-center items-center">
            <h1 className="w-7/12 pb-8 text-center text-7xl text-white text-shadow leading-normal font-montserrat font-semibold">
              Record & access your catches to improve your fishing journeys
            </h1>
            <a
              className="px-6 py-4 border-4 border-solid border-white rounded-2xl hover:no-underline text-5xl font-montserrat font-medium text-white text-shadow bg-transparent-shadow hover:bg-blue-700"
              href="#"
            >
              Sign up now
            </a>
      ...
      <footer className="flex h-[200px] justify-center items-center text-xl font-montserrat font-medium">
